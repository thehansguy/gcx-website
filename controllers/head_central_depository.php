...
<cms:template title='Central Depository'>

   <cms:editable name='group_central_depository' label='GCX  Central Depository' desc='Provide GCX Central Depository' type='group' />
    <cms:editable name='gcx_central_depository' required='1'  label='GCX Central Depository' group='group_central_depository' type='richtext'/>
