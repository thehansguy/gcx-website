...
<cms:template title='GCX News' clonable='1' order='1'>
    <cms:editable name='gcx_news_content' type='richtext' required='1' label='Provide news content' />
    <cms:editable name='gcx_news_image' label='Provide news image' 
                  type='image'
                  show_preview='1'
                  preview_width='150'
                  width='900'
