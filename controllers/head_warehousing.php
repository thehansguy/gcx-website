...
<cms:template title='Warehousing'>

    <cms:editable name='group_warehousing' label='GCX Warehousing' desc='Provide GCX Warehousing' type='group' />
    <cms:editable name='gcx_warehousing' required='1'  label='Trade Warehousing' group='group_warehousing' type='richtext'/>
