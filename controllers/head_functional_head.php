...
<cms:template clonable='1' title='Functional Heads'>
    <cms:editable name='gcx_heads_management_position' required='1'  label='Member Position' type='text'/>
    <cms:editable name='gcx_heads_management_profile' label='Member Profile' type='richtext' />
    ...
    <cms:folder name="gcx_heads" title="Functional Heads" />
</cms:template>
