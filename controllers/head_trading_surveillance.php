...
<cms:template title='Trade Surveillance'>

    <cms:editable name='group_trade_surveillance' label='GCX Trade Surveillance' desc='Provide GCX Trade Surveillance' type='group' />
    <cms:editable name='gcx_trade_surveillance' required='1'  label='Trade Surveillance' group='group_trade_surveillance' type='richtext'/>
