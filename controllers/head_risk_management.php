...
<cms:template title='Risk Management'>

    <cms:editable name='group_risk_management' label='GCX Risk Management' desc='Provide GCX Risk Management' type='group' />
    <cms:editable name='gcx_risk_management' required='1'  label='Risk Management' group='group_risk_management' type='richtext'/>
