...
<cms:template title='Electronic Spot Trading'>

    <cms:editable name='group_trading_system' label='Electronic Spot Trading'  type='group' />
    <cms:editable name='gcx_trading_system' required='1'  label='Electronic Spot Trading' group='group_trading_system' type='richtext'/>
