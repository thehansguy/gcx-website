...
<cms:template title='Clearing & Settlement'>

    <cms:editable name='group_clearing_settlement' label='GCX Clearing & Settlement' desc='Provide GCX Clearing & Settlement' type='group' />
    <cms:editable name='gcx_clearing_settlement' required='1'  label='Clearing & Settlement' group='group_clearing_settlement' type='richtext'/>
