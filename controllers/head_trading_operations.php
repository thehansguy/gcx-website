...
<cms:template title='Trading Operations'>

    <cms:editable name='group_trading_operations' label='GCX Trading Operations' type='group' />
    <cms:editable name='gcx_trading_operations' required='1'  label='Trading Operations' group='group_trading_operations' type='richtext'/>
